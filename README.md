...
--------------------------------------------------------
under below link file name postman_api.pdf is an 
**API DOCUMENTATION ** with POST MAN UI.
https://github.com/htoomyatag/SimpleShop/blob/main/public/postman_api.pdf

About SimpleShop Functionality
------------------------------
**About the user:**

There are two user admin and customer. 
Both users can
-   Sign up
-   Sign in
-   Sign out
...
Admin also can manage country courrency and tax for regions.

Customer can
-   add product to cart which has enough stock 
...
- responders - for json response message
- rack cors - for api cross calls
- devise jwt - for jwt login
- activemerchant - for test online payment
- faker - for seed data
- money - for different currency
- eu_central_bank - for currency rate
- sidekiq - for payment processing and order stages
- rspec - for test api
