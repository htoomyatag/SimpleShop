...
class CountriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create country" do
    assert_difference('Country.count') do
      post countries_url, params: { country: { country_code: @country.country_code, title: @country.title } }
    end
  ...
  test "should update country" do
    patch country_url(@country), params: { country: { country_code: @country.country_code, title: @country.title } }
