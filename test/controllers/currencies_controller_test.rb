...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { currency_code: @currency.currency_code, title: @currency.title } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { currency_code: @currency.currency_code, title: @currency.title } }
