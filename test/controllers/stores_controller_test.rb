...
class StoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create store" do
    assert_difference('Store.count') do
      post stores_url, params: { store: { region_id: @store.region_id, title: @store.title } }
    end
  ...
  test "should update store" do
    patch store_url(@store), params: { store: { region_id: @store.region_id, title: @store.title } }
