...
class UserRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_role" do
    assert_difference('UserRole.count') do
      post user_roles_url, params: { user_role: { description: @user_role.description, title: @user_role.title } }
    end
  ...
  test "should update user_role" do
    patch user_role_url(@user_role), params: { user_role: { description: @user_role.description, title: @user_role.title } }
